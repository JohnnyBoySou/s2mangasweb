...
import { Column, Row, Title, Label, Button } from '@/ui';
import './gradient.css'
        ...
        <Column style={{ overflowX: 'hidden', padding: 44, borderRadius: 8, flexGrow: 1, background: `radial-gradient(circle, #262626, #121212)`, }}>
            ...
            {step >= 1 &&
                <Column style={{ maxWidth: 600, alignSelf: 'center', marginBottom: 30, }}>
                    ...
                    <Row style={{ alignItems: 'center' }}>
                        <Button onClick={backStep} style={{ width: 44, height: 44, justifyContent: 'center', alignItems: 'center', fontSize: 26, textAlign: 'center', backgroundColor: '#50505090', padding: 0, }}>
                            <ArrowLeft style={{ marginTop: 6, }} />
                        </Button>
            ...
            {step == 1 &&
                <Column style={{ justifyContent: 'center', maxWidth: 1300, alignSelf: 'center', }} className='fadeInLeft'>
                    ...
                    {name.length > 1 && bio.length > 1 && <Button variant="primary" className='fadeInUp' onClick={() => setStep(2)} style={{ marginTop: 20, paddingTop: 15, paddingBottom: 15, }}>Continuar</Button>}
                </Column>}
            ...
            {step == 2 && <Column style={{ justifyContent: 'center', alignItems: 'center', maxWidth: 1300, alignSelf: 'center', }}>
                ...
                <Column style={{ padding: 42, }} className="fadeInLeft">
                    ...
                    {avatar?.length > 1 && <Button variant="primary" className='fadeInUp' onClick={() => setStep(3)} style={{ marginTop: 20, padding: '15px 32px', alignSelf: 'center' }}>Continuar</Button>}
            ...
            {step == 3 && <Column style={{ justifyContent: 'center', alignItems: 'center', maxWidth: 1300, alignSelf: 'center', }}>
                ...
                <Column style={{ padding: 42, }} className="fadeInLeft">
                    ...
                    {capa?.length > 1 && <Button variant="primary" className='fadeInUp' onClick={() => setStep(4)} style={{ marginTop: 20, padding: '15px 32px', alignSelf: 'center' }}>Continuar</Button>}
            ...
            {step == 4 && <Column style={{ justifyContent: 'center', maxWidth: 1300, alignSelf: 'center', }} className="fadeInLeft">
                <Row style={{ justifyContent: 'space-between', alignItems: 'center', }}>
                    ...
                    {categorias.length >= 3 && <Button variant="primary" className='fadeInUp' onClick={createtUser} style={{ marginTop: 20, paddingTop: 15, paddingBottom: 15, }}>Continuar</Button>}
                </Row>
